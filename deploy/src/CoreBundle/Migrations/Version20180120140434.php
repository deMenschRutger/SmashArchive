 ...
 */
class Version20180120140434 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE entrant CHANGE name name VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE entrant CHANGE name name VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci');
    }
}
