...
class Game
{
     ...
     *
     * @Serializer\Expose
     * @Serializer\Groups({"players_ranks", "players_sets", "tournaments_details", "players_overview"})
     */
    private $id;
     ...
     *
     * @Serializer\Expose
     * @Serializer\Groups({"players_overview", "players_details", "players_ranks", "players_sets", "tournaments_details"})
     */
    private $name;
