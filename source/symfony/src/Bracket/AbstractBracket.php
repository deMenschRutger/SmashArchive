...
abstract class AbstractBracket
{
    ...
    /**
     * @var AbstractRanksGenerator
     */
    protected $ranksGenerator;
    ...
    /**
     * @return AbstractRanksGenerator
     */
    abstract public function getRanksGenerator();
    ...
    {
        return $this->getRanksGenerator()->getRanks($event);
    }
